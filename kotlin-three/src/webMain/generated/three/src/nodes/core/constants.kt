...
sealed external interface NodeShaderStage: JsAny {
companion object {
...
sealed external interface NodeUpdateType: JsAny {
companion object {
...
sealed external interface NodeAccess: JsAny {
companion object {
...
external interface NodeShaderStage: JsAny {
val VERTEX: String /* "vertex" */
val FRAGMENT: String /* "fragment" */
}

external interface NodeUpdateType: JsAny {
...
external interface NodeType: JsAny {
...
external interface NodeAccess: JsAny {
