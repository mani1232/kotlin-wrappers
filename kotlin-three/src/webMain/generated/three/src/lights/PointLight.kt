...
// unhandled import: PointLightShadow from "./PointLightShadow.js"
...
external interface PointLightJSON : LightJSON {
var distance: Double
var decay: Double
 ...
 */
external class PointLight : Light<PointLightShadow> {
/**
     ...
     */
constructor (color: ColorRepresentation = definedExternally, intensity: Double = definedExternally, distance: Double = definedExternally, decay: Double = definedExternally)
/**
     * Read-only flag to check if a given object is of type {@link PointLight}.
     * @remarks This is a _constant_ value
     * @defaultValue `true`
     */
val isPointLight: Boolean /* true */
/**
     * @default 'PointLight'
     */
var type: String
...
/**
     ...
     */
var power: Double
fun toJSON(meta: JSONMeta = definedExternally): PointLightJSON
}
