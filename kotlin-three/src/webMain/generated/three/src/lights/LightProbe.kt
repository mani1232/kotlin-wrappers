...
// unhandled import: SphericalHarmonics3 from "../math/SphericalHarmonics3.js"
...
external interface LightProbeJSON : LightJSON {
var sh: js.array.ReadonlyArray<Double>
}
 ...
 */
external class LightProbe : Light {
/**
     ...
     */
constructor (sh: SphericalHarmonics3 = definedExternally, intensity: Double = definedExternally)
/**
     * Read-only flag to check if a given object is of type {@link DirectionalLight}.
     * @remarks This is a _constant_ value
     * @defaultValue `true`
     */
val isLightProbe: Boolean /* true */
/**
     * A light probe uses spherical harmonics to encode lighting information.
     * @defaultValue `new THREE.SphericalHarmonics3()`
     */
var sh: SphericalHarmonics3
fun toJSON(meta: JSONMeta = definedExternally): LightProbeJSON
}
