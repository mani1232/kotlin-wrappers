...
// unhandled import: DirectionalLightShadow from "./DirectionalLightShadow.js"
...
external interface DirectionalLightJSON : LightJSON {
 ...
 */
external class DirectionalLight : Light<DirectionalLightShadow> {
/**
...
/**
     ...
     * @defaultValue `true`
     */
val isDirectionalLight: Boolean /* true */
/**
     * A Read-only _string_ to check if `this` object type.
     * @remarks Sub-classes will update this value.
     * @defaultValue `DirectionalLight`
     */
val type: Any /* string | "DirectionalLight" */
/**
...
/**
     ...
     */
fun dispose(): Unit
fun toJSON(meta: JSONMeta = definedExternally): DirectionalLightJSON
}
