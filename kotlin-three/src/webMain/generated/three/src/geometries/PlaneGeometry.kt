 ...
 */
external class PlaneGeometry : BufferGeometry {
/**
     ...
     */
constructor (width: Double = definedExternally, height: Double = definedExternally, widthSegments: Double = definedExternally, heightSegments: Double = definedExternally)
/**
     * A Read-only _string_ to check if `this` object type.
     * @remarks Sub-classes will update this value.
     * @defaultValue `PlaneGeometry`
     */
val type: Any /* string | "PlaneGeometry" */
/**
     * An object with a property for each of the constructor parameters.
     * @remarks Any modification after instantiation does not change the geometry.
     */
val parameters: PlaneGeometryParameters
companion object {
/** @internal */
fun fromJSON(data: Any): PlaneGeometry
}
}
external interface PlaneGeometryParameters {
val width: Double
val height: Double
