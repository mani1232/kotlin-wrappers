 ...
 */
external class EdgesGeometry<TBufferGeometry : BufferGeometry /* default is BufferGeometry */> : BufferGeometry {
/**
     ...
     */
constructor (geometry: TBufferGeometry? = definedExternally, thresholdAngle: Double = definedExternally)
/**
     * A Read-only _string_ to check if `this` object type.
     * @remarks Sub-classes will update this value.
     * @defaultValue `EdgesGeometry`
     */
val type: Any /* string | "EdgesGeometry" */
/**
     * An object with a property for each of the constructor parameters.
     * @remarks Any modification after instantiation does not change the geometry.
     */
val parameters: EdgesGeometryParameters<TBufferGeometry>
}
external interface EdgesGeometryParameters<TBufferGeometry : BufferGeometry /* default is BufferGeometry */> {
