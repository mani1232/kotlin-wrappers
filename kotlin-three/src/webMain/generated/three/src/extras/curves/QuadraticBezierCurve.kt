 ...
 */
external class QuadraticBezierCurve : Curve<Vector2> {
/**
     ...
     */
constructor (v0: Vector2 = definedExternally, v1: Vector2 = definedExternally, v2: Vector2 = definedExternally)
/**
     * Read-only flag to check if a given object is of type {@link LineCurve3}.
     * @remarks This is a _constant_ value
     * @defaultValue `true`
     */
val isQuadraticBezierCurve: Any? /* type isn't declared */
/**
     * A Read-only _string_ to check if `this` object type.
     * @remarks Sub-classes will update this value.
     * @defaultValue `QuadraticBezierCurve`
     */
val type: Any /* string | "QuadraticBezierCurve" */
/**
     * The start point.
