...
// unhandled import: EllipseCurve from "./EllipseCurve.js"
 ...
 */
external class ArcCurve : EllipseCurve {
/**
     ...
     */
constructor (aX: Double = definedExternally, aY: Double = definedExternally, aRadius: Double = definedExternally, aStartAngle: Double = definedExternally, aEndAngle: Double = definedExternally, aClockwise: Boolean = definedExternally)
/**
     * Read-only flag to check if a given object is of type {@link ArcCurve}.
     * @remarks This is a _constant_ value
     * @defaultValue `true`
     */
val isArcCurve: Any? /* type isn't declared */
/**
     * A Read-only _string_ to check if `this` object type.
     * @remarks Sub-classes will update this value.
     * @defaultValue `ArcCurve`
     */
val type: Any /* string | "ArcCurve" */
}
