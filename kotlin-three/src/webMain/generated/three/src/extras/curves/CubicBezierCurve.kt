 ...
 */
external class CubicBezierCurve : Curve<Vector2> {
/**
     ...
     */
constructor (v0: Vector2 = definedExternally, v1: Vector2 = definedExternally, v2: Vector2 = definedExternally, v3: Vector2 = definedExternally)
/**
     * Read-only flag to check if a given object is of type {@link CubicBezierCurve}.
     * @remarks This is a _constant_ value
     * @defaultValue `true`
     */
val isCubicBezierCurve: Any? /* type isn't declared */
/**
     * A Read-only _string_ to check if `this` object type.
     * @remarks Sub-classes will update this value.
     * @defaultValue `CubicBezierCurve`
     */
val type: Any /* string | "CubicBezierCurve" */
/**
     * The starting point.
