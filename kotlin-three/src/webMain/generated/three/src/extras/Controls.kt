 ...
 */
external class Controls<TEventMap : Any> : EventDispatcher<TEventMap> {
/**
...
/**
     ...
     * @param domElement The HTML element used for event listeners. (optional)
     */
constructor (`object`: Object3D, domElement: HTMLElement? = definedExternally)
...
/**
     ...
     * @param domElement The HTML element used for event listeners. (optional)
     */
constructor (`object`: Object3D, domElement: SVGElement? = definedExternally)
/**
...
/**
     ...
     */
var domElement: Any? /* HTMLElement | SVGElement | null */
/**
...
/**
     ...
     */
fun connect(element: HTMLElement): Unit

/**
     * Connects the controls to the DOM. This method has so called "side effects" since it adds the module's event
     * listeners to the DOM.
     */
fun connect(element: SVGElement): Unit
/**
