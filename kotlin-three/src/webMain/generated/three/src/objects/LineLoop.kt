 ...
 */
external class LineLoop<TGeometry : BufferGeometry /* default is BufferGeometry */, TMaterial : Any /* Material | Material[] */ /* default is Any /* Material | Material[] */ */, TEventMap : Object3DEventMap /* default is Object3DEventMap */> : Line<TGeometry, TMaterial, TEventMap> {
/**
...
/**
     ...
     * @defaultValue `true`
     */
val isLineLoop: Boolean /* true */
/**
     * @override
     * @defaultValue `LineLoop`
     */
val type: Any /* string | "LineLoop" */
}
