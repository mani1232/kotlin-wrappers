...
// unhandled import: PixelFormatGPU from "../constants.js"
...
// unhandled import: CubeTexture from "./CubeTexture.js"
// unhandled import: Source from "./Source.js"
...
external interface TextureParameters {
...
var metadata: TextureJSONMetadata
var uuid: String
var name: String
var image: String
var mapping: AnyMapping
var channel: Double
var repeat: js.array.Tuple2</* x: */ Double, /* y: */ Double>
var offset: js.array.Tuple2</* x: */ Double, /* y: */ Double>
var center: js.array.Tuple2</* x: */ Double, /* y: */ Double>
var rotation: Double
var wrap: js.array.Tuple2</* wrapS: */ Double, /* wrapT: */ Double>
...
/**
     * @deprecated
     */
constructor (image: TImage, mapping: Mapping, wrapS: Wrapping, wrapT: Wrapping, magFilter: MagnificationTextureFilter, minFilter: MinificationTextureFilter, format: PixelFormat, type: TextureDataType, anisotropy: Double)
/**
     ...
     */
constructor (image: TImage = definedExternally, mapping: Mapping = definedExternally, wrapS: Wrapping = definedExternally, wrapT: Wrapping = definedExternally, magFilter: MagnificationTextureFilter = definedExternally, minFilter: MinificationTextureFilter = definedExternally, format: PixelFormat = definedExternally, type: TextureDataType = definedExternally, anisotropy: Double = definedExternally, colorSpace: ColorSpace = definedExternally)
/**
     * Read-only flag to check if a given object is of type {@link Texture}.
     * @remarks This is a _constant_ value
     * @defaultValue `true`
     */
val isTexture: Boolean /* true */
/**
...
/**
     ...
     * @defaultValue `[]`
     */
var mipmaps: Any /* CompressedTextureMipmap[] | CubeTexture[] | HTMLCanvasElement[] */
/**
...
/**
     ...
     * @defaultValue `4`
     */
var unpackAlignment: Double// TODO Fix typing to only allow the expected values.
...
/**
     ...
     */
var onUpdate: ((texture: Texture) -> Unit)?
/**
...
/**
     ...
     */
fun clone(): Unit /* this */
fun copy(source: Texture<TImage>): Unit /* this */
/**
     * Sets this texture's properties based on `values`.
     * @param values - A container with texture parameters.
     */
fun setValues(values: TextureParameters): Unit
/**
     ...
     */
fun toJSON(): TextureJSON

/**
     * Convert the texture to three.js {@link https://github.com/mrdoob/three.js/wiki/JSON-Object-Scene-format-4 | JSON Object/Scene format}.
     * @param meta Optional object containing metadata.
     */
fun toJSON(meta: String = definedExternally): TextureJSON

/**
     * Convert the texture to three.js {@link https://github.com/mrdoob/three.js/wiki/JSON-Object-Scene-format-4 | JSON Object/Scene format}.
     * @param meta Optional object containing metadata.
     */
fun toJSON(meta: Any = definedExternally): TextureJSON
/**
