 ...
 */
external class QuadraticBezierCurve3 : Curve<Vector3> {
/**
     ...
     */
constructor (v0: Vector3 = definedExternally, v1: Vector3 = definedExternally, v2: Vector3 = definedExternally)
/**
     * Read-only flag to check if a given object is of type {@link QuadraticBezierCurve3}.
     * @remarks This is a _constant_ value
     * @defaultValue `true`
     */
val isQuadraticBezierCurve3: Any? /* type isn't declared */
/**
     * A Read-only _string_ to check if `this` object type.
     * @remarks Sub-classes will update this value.
     * @defaultValue `QuadraticBezierCurve3`
     */
val type: Any /* string | "QuadraticBezierCurve3" */
/**
     * The start point.
