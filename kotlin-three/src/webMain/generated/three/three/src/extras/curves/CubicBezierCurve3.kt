 ...
 */
external class CubicBezierCurve3 : Curve<Vector3> {
/**
     ...
     */
constructor (v0: Vector3 = definedExternally, v1: Vector3 = definedExternally, v2: Vector3 = definedExternally, v3: Vector3 = definedExternally)
/**
     * Read-only flag to check if a given object is of type {@link CubicBezierCurve3}.
     * @remarks This is a _constant_ value
     * @defaultValue `true`
     */
val isCubicBezierCurve3: Any? /* type isn't declared */
/**
     * A Read-only _string_ to check if `this` object type.
     * @remarks Sub-classes will update this value.
     * @defaultValue `CubicBezierCurve3`
     */
val type: Any /* string | "CubicBezierCurve3" */
/**
     * The starting point.
