...
// unhandled import: Ray from "../math/Ray.js"
// unhandled import: Vector2 from "../math/Vector2.js"
// unhandled import: Vector3 from "../math/Vector3.js"
// unhandled import: XRTargetRaySpace from "../renderers/webxr/WebXRController.js"
// unhandled import: Layers from "./Layers.js"
// unhandled import: Object3D from "./Object3D.js"
...
external interface Intersection<TIntersected : Object3D /* default is Object3D */> {
...
var Mesh: Any?
var Line: RaycasterParametersLine
var Line2: (RaycasterParametersLine2)?
var LOD: Any?
var Points: RaycasterParametersPoints
var Sprite: Any?
}
...
/**
     ...
     */
constructor (origin: Vector3 = definedExternally, direction: Vector3 = definedExternally, near: Double = definedExternally, far: Double = definedExternally)
/**
...
/**
     ...
     */
fun set(origin: Vector3, direction: Vector3): Unit
/**
     * Updates the ray with a new origin and direction.
     * @param coords 2D coordinates of the mouse, in normalized device coordinates (NDC)---X and Y components should be between -1 and 1.
     * @param camera camera from which the ray should originate
     */
fun setFromCamera(coords: Vector2, camera: Camera): Unit
/**
     * Updates the ray with a new origin and direction.
     * @param controller The controller to copy the position and direction from.
     */
fun setFromXRController(controller: XRTargetRaySpace): Unit /* this */
/**
     ...
     */
fun <TIntersected : Object3D> intersectObject(`object`: Object3D, recursive: Boolean = definedExternally, optionalTarget: Array<Intersection<TIntersected>> = definedExternally): Array<Intersection<TIntersected>>
/**
     ...
     * @returns An array of intersections is returned.
     */
fun <TIntersected : Object3D> intersectObjects(objects: js.array.ReadonlyArray<Object3D>, recursive: Boolean = definedExternally, optionalTarget: Array<Intersection<TIntersected>> = definedExternally): Array<Intersection<TIntersected>>
}
external interface RaycasterParametersLine {
var threshold: Double
}

external interface RaycasterParametersLine2 {
var threshold: Double
}

external interface RaycasterParametersPoints {
var threshold: Double
}