...
external interface PointsMaterialProperties : MaterialProperties, PointsNodeMaterialNodeProperties {
/**
...
external interface PointsMaterialParameters : Partial<MapColorPropertiesToColorRepresentations<PointsMaterialProperties>> {
 ...
 * ```
 */
external class PointsMaterial : Material, PointsMaterialProperties {
/**
     ...
     * by {@link Color#set}.
     */
constructor (parameters: PointsMaterialParameters = definedExternally)
/**
     * This flag can be used for type testing.
     *
     * @default true
     */
val isPointsMaterial: Boolean
fun setValues(values: PointsMaterialParameters = definedExternally): Unit
}
